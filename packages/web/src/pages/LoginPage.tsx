      ...
      <div className="bg-white rounded-2xl shadow-modal p-8 w-full max-w-sm mx-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            ...
            className="flex items-center justify-center gap-2 border border-tg-divider rounded-lg px-4 py-2.5 text-sm font-medium hover:bg-gray-50 transition-colors"
          >
